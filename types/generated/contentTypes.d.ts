...
export interface ApiDemoDemo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    name: Schema.Attribute.String;
    demo_cmp: Schema.Attribute.Component<'basic.demo-comp', false>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiFormGroupFormGroup extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    inputs: Schema.Attribute.Component<'basic.input', true> &
      Schema.Attribute.Required;
...
export interface ApiInputGroupInputGroup extends Struct.CollectionTypeSchema {
...
export interface ApiSectionSection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    illustrations: Schema.Attribute.Component<'basic.illustrations', false>;
    button: Schema.Attribute.Component<'basic.button', false>;
    layout: Schema.Attribute.Component<'basic.layout', false> &
      Schema.Attribute.Required;
    pages: Schema.Attribute.Relation<'manyToMany', 'api::page.page'>;
    photos: Schema.Attribute.Relation<'manyToMany', 'api::photo.photo'>;
    cards: Schema.Attribute.Relation<'manyToMany', 'api::card.card'>;
    filter_list: Schema.Attribute.Component<'basic.filter', true>;
    variant: Schema.Attribute.Component<'basic.variant', false> &
      Schema.Attribute.Required;
